...
describe("SuggestionsCard", () => {
  ...
  //     const cardHeader = screen.getByRole("region", { name: /card header/i });
  ...
  //     render(<SuggestionsCard el={mockData} />);
  //     const actionIcons = screen.getAllByRole("button", { name: /action/i });
  ...
  //     const actionIcon = screen.getByRole("button", { name: /action/i });
